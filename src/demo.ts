import { FilterOptionsT, VisualizationT } from './types';
const options = [
    { label: 'Dhaka', id: 1, type: 'division', child: 'district' },
    { label: 'Khulna', id: 2, type: 'division', child: 'district' },
    { label: 'Rangpur', id: 3, type: 'division', child: 'district' },
    { label: 'Barisal', id: 4, type: 'division', child: 'district' }
];
const radioOptions = [
    { label: 'Male', id: 1, type: 'division', child: 'district' },
    { label: 'Female', id: 2, type: 'division', child: 'district' },
    { label: 'Other', id: 3, type: 'division', child: 'district' }
];

export const filterOptions: FilterOptionsT[] = [
    {
        title: 'Division',
        appearance: 'dropdown',
...
export const optionsDistrict = [
    { label: 'Dhaka', id: 1, type: 'district', child: 'upazila' },
    { label: 'Rajshahi', id: 2, type: 'district', child: 'upazila' },
    { label: 'Khulna', id: 3, type: 'district', child: 'upazila' },
    { label: 'Gazipur', id: 4, type: 'district', child: 'upazila' },
    { label: 'Manikganj', id: 5, type: 'district', child: 'upazila' }
];
...
export const visualizationDemo: VisualizationT[] = [
    {
        ...
        config: {
            ...
            options: {
                ...
                tooltip: {
                    ...
                    y: {
                        title: {
                            formatter: (_seriesName: any) => 'Stock - '
                        }
                    },
                    marker: {
                        show: false
        ...
        config: {
            ...
            districts: [
                ...
                },
                {
                    ...
                    value: 0,
                    d:
                        'M256.193 140.601l6.214-6.157 6.214 1.231 6.214 4.926-4.971 13.546 7.456 2.463 6.214 7.39 7.457-1.232-1.243-8.62-6.214-3.695 7.457-8.62 13.67 1.231 6.214 8.62 4.972 6.158 3.728 6.157 2.485-3.694h11.185l2.486 2.463 7.457-3.695v8.62l1.242 14.778 8.7 6.158 8.7 4.926 2.485 6.157-1.243 7.389-2.486 18.472 3.729 12.315 2.485 13.546 9.943 8.62 11.185 7.39 8.699 7.388-3.728 9.852-3.729 8.62-3.728 4.926-7.457-8.62-12.427 11.083 1.242 13.547-9.942-9.852-6.214 12.315-19.884-4.926-13.67 3.694 4.97 12.315-6.214 7.389-3.728 6.157-11.185-1.231-9.942-8.62h-6.214v-13.547l-9.942-2.463v-29.555l-4.971-6.158-4.971-8.62-13.67-3.695 1.242-6.157-3.728-2.463v-9.852l-1.243-3.694 4.97-6.158-3.727 6.158 7.456-11.083 7.457-3.695v-20.935l3.728-7.389v-4.926l-1.243-17.24 3.729-7.39-13.67-14.777V140.6z'
                },
                {
                    id: 'panchagarh',
                    geo_code: '5577',
                ...
                },
                {
                    ...
                    value: 0,
                    d:
                        'M54.863 322.86l-6.213-11.083-7.457-9.852 4.97-11.083-12.427-2.463 3.729-19.704 8.699-6.157-1.243-7.39 4.971-9.851 14.914-9.852 4.97-13.546-11.184-6.158 6.214-11.083 2.485-11.083 13.67-4.926v-12.315l18.642 2.463 13.67-3.695 18.643 12.315 3.728-9.852 12.686-2.64 10.927 3.872 9.942-1.232 24.855 6.158 9.943 11.083 8.699 3.695 12.428 14.777-8.7 12.315 2.486 8.62-6.214 6.158-2.486 9.852h-8.699l-6.214-9.852-3.728 7.389h-7.457l-3.728 13.546 4.97 4.926-6.213 1.231-7.457 12.315-2.485 7.39-3.728 7.388 4.97 6.157-7.456 1.232h-4.971v-6.157l-16.156 1.231v9.852h-6.214l-1.243 12.315 7.457 3.694-4.971 4.926v11.083l6.214 3.695 7.456 6.157-1.243 8.62-8.699 1.232-7.457-7.389-6.214-3.694v-4.926l-8.699-8.62h-7.457l-2.485-8.621-13.67-7.389 1.242-6.157-1.243-3.695-11.185 3.695-7.456 6.157-6.214-7.389-14.914 12.315z'
                },
                {
                    id: 'lalmonirhat',
                    geo_code: '5552',
                ...
                },
                {
                    ...
                    value: 0,
                    d:
                        'M426.454 826.535v-18.472l-6.214-4.926v-4.926l-8.7-7.389 33.555-40.638-2.485-4.926h22.37l8.7 7.389h8.699l11.185-6.158 9.942 4.926 2.485-8.62 4.971 9.852 8.7 2.463v-6.158h6.214l6.214-4.926-9.943-6.157 4.972-4.926-8.7-7.389-7.457 1.232-2.485-1.232 6.214-6.157-6.214-3.695 3.728-13.546v-8.62l6.214 6.157 7.457-2.463 7.456 7.389 16.157-17.24-2.486-7.39 2.486-12.315 14.913 1.232 4.971 6.157 3.728 3.695 2.486-4.926h3.728l6.214 6.157 3.728 1.232 1.243 7.389-7.456 1.231-1.243 3.695 7.456 6.157v18.472l-2.485 9.852h-7.457l6.214 7.389 1.243 8.62-6.214 3.695-1.243 7.389-4.97-1.232-6.215 7.389 6.214 8.62v9.852l-8.7 6.158-3.728 6.157 17.4 18.472-7.457 7.39 1.242 4.925 8.7 6.157 6.214 9.852-2.486 35.713 3.728 4.926-3.728 3.694v4.926l3.728 1.232 4.972 4.926v3.694l3.728 3.695-1.243 14.777-8.7 17.241-16.155 6.158h-8.7l-9.942-12.315-14.913-11.084h-11.185l-16.157-13.546-12.427-2.463-1.243-6.157 6.214-2.463 1.243-8.62-4.972-2.463 3.729-2.463v-4.926l-4.971-6.158-3.729 2.463-11.185 2.463-3.728-2.463v-8.62l4.971-2.463s0-7.389-4.971-7.389h-6.214l-3.728 6.157h-2.486l-2.485-7.388v-9.852l-11.185-7.39-9.942-2.462-17.4-3.695z'
                },
                {
                    id: 'pabna',
                    geo_code: '5076',
                ...
                },
                {
                    ...
                    value: 0,
                    d:
                        'M476.165 1209.526l-6.214-8.62 9.942-1.232 9.942-9.852 3.729-3.694 7.456 11.083 8.7-3.695 6.214-8.62h13.67l3.728 9.852h9.943l1.242 2.463-8.699 9.852 3.728 7.389h13.67l6.215 7.389v4.925l-3.729 6.158 3.729 1.231 8.7-6.157 9.941 1.231-1.242 8.62-3.729 8.621-4.97 9.852h-6.215l-9.942-2.463 16.156 13.546 4.971 7.39 4.971 12.314 13.67 8.62v6.158l-3.727 1.231-11.185 2.463-28.584-11.083-9.942 11.083-16.157-8.62-4.97 7.389h-3.729l-13.67-16.01 4.97-7.388-3.728-7.39-12.428-1.23-6.213-6.158 2.485-9.852-4.97-1.232-11.186 11.084 2.486-9.852-1.243-7.389-7.457-2.463 13.67-2.463-2.485-11.083 4.971-4.926-2.485-18.472z'
                },
                {
                    id: 'satkhira',
                    geo_code: '4087',
