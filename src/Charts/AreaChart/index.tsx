...
const AreaChart = ({ chartData }: ChartPropsT) => {
        ...
        <>
            ...
            <Grid container direction="column" spacing={3}>
                <Grid item container spacing={3} alignItems="center">
                    <Grid item>
                        <Typography variant="h5">Market Share</Typography>
                    </Grid>
                    ...
                    <Grid item>
                        <Typography variant="h5">27, 695.65</Typography>
                    </Grid>
                </Grid>
                <Grid item xs={12}>
                    <Typography sx={{ mt: -2.5, fontWeight: 400 }} color="inherit" variant="h6">
                    ...
                    <Grid item>
                        <Grid container alignItems="center" spacing={1}>
                            ...
                            <Grid item sm zeroMinWidth>
                                <Typography variant="h5">+45.36%</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item>
                        <Grid container alignItems="center" spacing={1}>
                            ...
                            <Grid item sm zeroMinWidth>
                                <Typography variant="h5">- 50.69%</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item>
                        <Grid container alignItems="center" spacing={2}>
                            ...
                            <Grid item sm zeroMinWidth>
                                <Typography variant="h5">+ 16.85%</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item xs zeroMinWidth />
