import React__default, { useEffect, createElement, useState } from 'react';
import { useSelector, useDispatch, Provider } from 'react-redux';
import { Box, CardHeader, Divider, Grid, Typography, Card, CardContent, InputLabel, TextField as TextField$1, FormGroup, FormLabel, FormControlLabel, Checkbox, Autocomplete as Autocomplete$1, FormControl, RadioGroup, Radio, Button, Container, Tooltip, IconButton as IconButton$1, OutlinedInput, InputAdornment, TablePagination, TableSortLabel } from '@mui/material';
...
function useUiConfigChangeReducer(item) {
  ...
  var dispatch = useDispatch(); // for accordion
...
var AreaChart = function AreaChart(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, (chartData == null ? void 0 : chartData.title) && React__default.createElement(Box, {
    marginBottom: 2
  ...
  }), React__default.createElement(Divider, null)), React__default.createElement(Grid, {
    container: true,
    direction: "column",
    spacing: 3
    ...
    variant: "h5"
  }, "Market Share")), React__default.createElement(Grid, {
    item: true,
    xs: true,
    zeroMinWidth: true
  }), React__default.createElement(Grid, {
    ...
    variant: "h5"
  }, "27, 695.65"))), React__default.createElement(Grid, {
    item: true,
    xs: 12
  }, React__default.createElement(Typography, {
    sx: {
    ...
    color: "inherit",
    variant: "h6"
  }, "Department wise monthly sales report")), React__default.createElement(Grid, {
    item: true,
    container: true,
  ...
  }, React__default.createElement(IconBrandFacebook, {
    stroke: 1.5
  }))), React__default.createElement(Grid, {
    item: true,
    sm: true,
    ...
    variant: "h5"
  }, "+45.36%")))), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Grid, {
    container: true,
    alignItems: "center",
  ...
  }, React__default.createElement(IconBrandTwitter, {
    stroke: 1.5
  }))), React__default.createElement(Grid, {
    item: true,
    sm: true,
    ...
    variant: "h5"
  }, "- 50.69%")))), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Grid, {
    container: true,
    alignItems: "center",
  ...
  }, React__default.createElement(IconBrandYoutube, {
    stroke: 2
  }))), React__default.createElement(Grid, {
    item: true,
    sm: true,
    ...
    variant: "h5"
  }, "+ 16.85%")))), React__default.createElement(Grid, {
    item: true,
    xs: true,
    zeroMinWidth: true
...
var BarChart = function BarChart(_ref) {
  ...
  var config = chartData.config;
  useUiConfigChangeReducer(chartData);
  return React__default.createElement(React__default.Fragment, null, chartData.title && React__default.createElement(Box, {
    marginBottom: 2
  }, React__default.createElement(CardHeader, {
    title: chartData.title,
    sx: {
  ...
  }), React__default.createElement(Divider, null)), React__default.createElement(Box, {
    sx: {
      p: 3
    }
  }, React__default.createElement(Grid, {
    ...
    variant: "subtitle1"
  }, "New Stock")), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Typography, {
    variant: "caption"
  }, "(Purchased)"))), React__default.createElement(Grid, {
    container: true,
    spacing: 2,
    alignItems: "center"
  }, React__default.createElement(Grid, {
    ...
    variant: "h4"
  }, "0.85%")), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Grid, {
    container: true,
    spacing: 1,
...
var LineChart = function LineChart(_ref) {
  ...
  }), React__default.createElement(Divider, null)), React__default.createElement(Card, null, React__default.createElement(Box, {
    sx: {
  ...
  }, "4000")), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Typography, {
    variant: "body2",
    color: chartData.textColorForChart
  }, "42%"))), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Typography, {
    variant: "body2",
    color: chartData.textColorForChart
...
var PieChart = function PieChart(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, chartData.title && React__default.createElement(Box, {
    ...
    variant: "subtitle1"
  }, "Customer Satisfaction")), React__default.createElement(Grid, {
    item: true
  }, React__default.createElement(Chart, Object.assign({}, config)))));
};
...
var DashboardCard = function DashboardCard(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, item.title && React__default.createElement(Box, {
    marginBottom: 2
  }, React__default.createElement(CardHeader, {
    title: item.title,
    sx: {
    ...
    return React__default.createElement(Grid, {
      ...
      key: index
    }, React__default.createElement(CardContent, null, React__default.createElement(IconWrapper, null, React__default.createElement(EmojiEventsTwoToneIcon, null)), React__default.createElement(Grid, {
      container: true,
      direction: "column",
      ...
      align: "center",
      color: "inherit"
    }, card.value)), React__default.createElement(Grid, {
      item: true,
      sm: 12
    }, React__default.createElement(Typography, {
      variant: "body1",
...
var Accordion = /*#__PURE__*/styled(function (props) {
  return createElement(MuiAccordion, Object.assign({
    disableGutters: true,
    elevation: 0,
    square: true
  }, props));
...
var AccordionSummary = /*#__PURE__*/styled(function (props) {
  return createElement(MuiAccordionSummary, Object.assign({
    expandIcon: createElement(ArrowForwardIosSharpIcon, {
      sx: {
        fontSize: '0.9rem'
      }
    })
...
var AccordionDetails = /*#__PURE__*/styled(MuiAccordionDetails)(function (_ref3) {
...
function CustomizedAccordions(_ref4) {
  ...
  }, title)), createElement(AccordionDetails, null, children)));
}
...
function DateField(prop) {
  ...
  }, React__default.createElement(InputLabel, null, prop.title), React__default.createElement(LocalizationProvider, {
...
function DateRangeField(prop) {
  ...
  }, React__default.createElement(InputLabel, null, prop.title), React__default.createElement(DateRangePicker, {
    format: 'dd-MM-yyyy',
...
function DropdownMultipleField(prop) {
  ...
  return React__default.createElement(Grid, {
    ...
    renderInput: function renderInput(params) {
      return React__default.createElement(TextField$2, Object.assign({}, params, {
        fullWidth: true
      }));
    }
  }));
...
function DropdownSingleField(prop) {
  ...
  }, React__default.createElement(InputLabel$1, null, prop.title), React__default.createElement(Autocomplete, {
    disablePortal: true,
    options: movies,
    value: filters[prop.title] || '',
...
function NumberField(prop) {
  ...
  }, React__default.createElement(InputLabel, null, prop.title), React__default.createElement(TextField$1, {
    type: "number",
    variant: "outlined",
    fullWidth: true,
    value: filters[prop.title] || '',
...
function CheckboxField(prop) {
  ...
  return React__default.createElement(Grid, {
    ...
    component: "legend"
  }, prop.title), React__default.createElement(Box, {
    display: "inline"
  }, checkboxOptions.map(function (opt, index) {
    return React__default.createElement(FormControlLabel, {
      label: opt.label,
      key: index,
      control: React__default.createElement(Checkbox, Object.assign({}, isItemChecked(String(opt.id)), {
        value: String(opt.id),
        onChange: function onChange(e) {
          return handleChange(e.target.value);
        }
...
function DropdownWithCheckbox(prop) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Grid, {
  ...
  }, React__default.createElement(InputLabel, null, prop.title), React__default.createElement(Autocomplete$1, {
    multiple: true,
    ...
    renderOption: function renderOption(props, option, _ref) {
      ...
      return React__default.createElement("li", Object.assign({}, props), React__default.createElement(Checkbox$1, {
        icon: icon,
...
function RadioField(prop) {
  ...
  }, React__default.createElement(FormControl, null, React__default.createElement(FormLabel, {
    id: "radio_" + prop.title
  }, prop.title), React__default.createElement(RadioGroup, {
    value: filters[prop.title] || '',
    name: prop.title,
    onChange: function onChange(e) {
      return handleChange(e.target.value);
...
var DrawerHeader = /*#__PURE__*/styled('div')(function (_ref) {
  var theme = _ref.theme;
  return _extends({
    display: 'flex',
    alignItems: 'center',
...
function PersistentDrawer(_ref2) {
  ...
  return createElement(Box$2, {
  ...
  }, createElement(FilterAltIcon, null), " ", title)), createElement(Drawer, {
    sx: {
      flexShrink: 0,
      '& .MuiDrawer-paper': {
    ...
    anchor: "right",
    open: drawerOpen
  }, createElement(DrawerHeader, null, createElement(IconButton, {
    onClick: handleDrawerClose
  }, theme.direction === 'rtl' ? createElement(ChevronLeftIcon, null) : createElement(ChevronRightIcon, null))), createElement(Divider$1, null), createElement(Container, null, children)));
}
...
var SubCard = /*#__PURE__*/React__default.forwardRef(function (_ref, ref) {
  ...
  var theme = useTheme();
  return React__default.createElement(Card, Object.assign({
    ref: ref,
    sx: _extends({
      border: '1px solid',
  ...
  }, others), !darkTitle && _title && React__default.createElement(CardHeader, {
    sx: {
      p: 2.5
    },
    ...
    action: secondary
  }), darkTitle && _title && React__default.createElement(CardHeader, {
    sx: {
      p: 2.5
    },
    title: React__default.createElement(Typography, {
    ...
    action: secondary
  }), _title && React__default.createElement(Divider, {
    sx: {
      opacity: 1,
      borderColor: theme.palette.mode === 'dark' ? '#f1f3f4' : 'lightgray'
    }
  }), content && React__default.createElement(CardContent, {
    sx: _extends({
      p: 2.5
    }, contentSX),
...
var useStyle = /*#__PURE__*/makeStyles(function (_theme) {
  return {
    map: {
      height: '500px',
      width: '500px',
...
function Map(_ref) {
  ...
  var _useState = useState(config ? config.divisions : divisions),
      mapOfDivision = _useState[0],
      setMapOfDivision = _useState[1];

  var _useState2 = useState(config ? config.districts : districts),
  ...
  var divisionPath = mapOfDivision.map(function (path) {
    return React__default.createElement(Path, {
      ...
      title: React__default.createElement(React__default.Fragment, null, React__default.createElement(Box, {
        display: "flex"
      }, React__default.createElement(Typography, {
        variant: "subtitle2",
        color: "white"
  ...
  return React__default.createElement(TransformWrapper, {
    initialScale: 0.9,
    minScale: 0.5,
    maxScale: 4,
    ...
    var zoomIn = _ref2.zoomIn,
        ...
        state = _ref2.state;
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(Card, null, React__default.createElement(Box, {
      sx: {
    ...
    }))), React__default.createElement(TransformComponent, null, React__default.createElement(Box, {
      height: "75vh",
      width: "100vw"
...
function Maps(_ref) {
  var item = _ref.item;
  return React__default.createElement(React__default.Fragment, null, item.title && React__default.createElement(React__default.Fragment, null, React__default.createElement(CardHeader, {
    title: item.title,
    sx: {
      textAlign: item.titlePosition
    }
  }), React__default.createElement(Divider, null)), React__default.createElement(Map, Object.assign({}, item)));
}
...
function Table(_ref) {
  ...
  return React__default.createElement(MaUTable, Object.assign({}, getTableProps()), React__default.createElement(TableHead, null, headerGroups.map(function (headerGroup) {
    return React__default.createElement(TableRow, Object.assign({}, headerGroup.getHeaderGroupProps()), headerGroup.headers.map(function (column) {
      ...
      }), !column.disableSortBy ? React__default.createElement(TableSortLabel, {
...
function MTable(_ref2) {
  ...
  return React__default.createElement("div", null, item.title && React__default.createElement(Box, {
    marginBottom: 2
  }, React__default.createElement(CardHeader, {
    title: item.title,
    sx: {
    ...
    marginBottom: 2,
    textAlign: "right"
  }, React__default.createElement(OutlinedInput, {
    id: "outlined-basic",
    type: "text",
    value: search,
    placeholder: "Search",
    ...
    data: config.data
  }), count && React__default.createElement(TablePagination, {
    component: "div",
    count: count ? count : 0,
...
var store = /*#__PURE__*/createStore(reducer, /*#__PURE__*/composeWithDevTools( /*#__PURE__*/applyMiddleware(thunk)));
...
//# sourceMappingURL=dashboardvisualization.esm.js.map
