...
export declare type VisualizationT = {
    title?: string;
...
export declare type ChartPropsT = {
    chartData: VisualizationT;
};
export declare type ComponentT = {
    item: VisualizationT;
};
...
export declare type FilterOptionsT = {
    title: string;
    appearance: string;
...
export declare type FilterSectionT = {
    item: VisualizationT;
    dataObject: Object;
};
export declare type PathT = {
    id: string;
    geo_code: string;
    value: number;
    d: string;
